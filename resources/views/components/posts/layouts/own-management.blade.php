<div {{ $attributes->class('lg:grid lg:grid-cols-12 lg:gap-x-5') }}>
    <aside class="py-6 px-2 sm:px-6 lg:py-0 lg:px-0 lg:col-span-3">
        <nav class="space-y-1">
            ...
            <a href="{{ route('posts.viewOwnDashboard') }}" @class(['text-gray-700 hover:text-gray-800 hover:bg-gray-50
                group rounded-md px-3 py-2 flex items-center text-sm font-medium' ,'bg-gray-50 text-indigo-600
                hover:bg-white'=>request()->routeIs('posts.viewOwnDashboard')])>
                <x-icons.adjustments :class="'text-gray-400 group-hover:text-gray-500 flex-shrink-0 -ml-1 mr-3 h-6 w-6 '
                .( request()->routeIs('posts.viewOwnDashboard') ?: 'text-indigo-500 group-hover:text-indigo-600')" />
            ...
            <a href="{{ route('posts.viewOwn') }}" @class(['text-gray-700 hover:text-gray-800 hover:bg-gray-50 group
                rounded-md px-3 py-2 flex items-center text-sm font-medium' ,'bg-gray-50 text-indigo-600
                hover:bg-white'=>request()->routeIs('posts.viewOwn')])>
                <x-icons.clipboard-list :class="'text-gray-400 group-hover:text-gray-500 flex-shrink-0 -ml-1 mr-3 h-6 w-6 '
            .( request()->routeIs('posts.viewOwn') ?: 'text-indigo-500 group-hover:text-indigo-600')" />
                <span class="truncate"> Bài đăng của bạn </span>
            </a>
