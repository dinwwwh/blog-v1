    ...
    <footer class="mt-24 bg-gray-700 sm:mt-12">
        <div class="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <div class="mt-8 flex justify-center space-x-6">
                ...
                <a href="https://fb.com/dinhdjj" class="text-gray-400 hover:text-gray-300">
            ...
            <p class="mt-8 text-center text-base text-gray-400 hover:text-gray-300">
                <a href="https://fb.com/dinhdjj">
                    © Made by @dinhdjj
                </a>
            </p>
        </div>
